package com.atguigu.core.day02.double_value

import org.apache.spark.rdd.RDD
import org.apache.spark.{SparkConf, SparkContext}

/**
  * 注意：it1.zipall(it2,100,200),若it1缺用100补，若it2缺用200补。
  * Author lzc
...
//        val rdd3 = rdd1.zipPartitions(rdd2)((it1, it2) => it1.zipAll(it2, 200, 100))  //两两分区进行拉链
